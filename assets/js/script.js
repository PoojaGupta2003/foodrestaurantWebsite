...
Rs('.slider-indicators-wrapper').slick({
  slidesToShow: 5,
  slidesToScroll: 1,
  asNavFor: '#our-menus',
  dots: false,
...
Rs('#our-menus').on('beforeChange', function(event, slick, currentSlide, nextSlide) {
  var RsnextSlide = Rs(slick.Rsslides[nextSlide]);
  var RscurrentSlide = Rs(slick.Rsslides[currentSlide]);
...
// Testimonials Slider
Rs('.testimonials .slider-content').slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: false,
  fade: false,
...
Rs('.testimonials .slider-nav').slick({
  slidesToShow: 3,
  slidesToScroll: 1,
...
// Our Chefs Slider
Rs('.our-chefs .our-chef-slider-wrapper').slick({
  slidesToShow: 3,
  slidesToScroll: 1,
  arrows: true,
  focusOnSelect: true,
...
Rs('.chef-choise-icons .fa-chevron-up').on('click', function() {
  Rs('.chef-choise-slider').slick('slickPrev');
});

Rs('.chef-choise-icons .fa-chevron-down').on('click', function() {
  Rs('.chef-choise-slider').slick('slickNext');
});
